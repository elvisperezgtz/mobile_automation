...
Feature: Cobro con tarjeta bloqueada
  ...
  Requiero que cuando la lectura de tarjeta desde el dispositivo mPOS este en proceso, la aplicación tenga la capacidad de detectar el error de Lectura que se produce en el dispositivo mPOS cuando no se ingresa una tarjeta y
